  ...
  if(isset($_REQUEST['type']) && $_REQUEST['type']!='')
      {
        if($_REQUEST['type']=='status')
        {
          ...
          $update_status_sql="update request set finance=$status where id=$id";
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Hello, <span class="text-black fw-bold">Finance</span></h1>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="mb-1 mt-3 font-weight-semibold">Finance</p>
                <p class="fw-light text-muted mb-0">finance@gmail.com</p>
              </div>
