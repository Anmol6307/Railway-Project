  ...
  if(isset($_REQUEST['type']) && $_REQUEST['type']!='')
      {
        if($_REQUEST['type']=='status')
        {
          ...
          $update_status_sql="update request set placed=$status where id=$id";
  ...
  <div class="container-scroller"> 
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Hello, <span class="text-black fw-bold">Section Incharge</span></h1>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="mb-1 mt-3 font-weight-semibold">Section Incharge</p>
                <p class="fw-light text-muted mb-0">sectionincharge@gmail.com</p>
              </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
       ...
       <li class="nav-item">
            <a class="nav-link" href="finance_conform.php">
              <i class="mdi mdi-grid-large menu-icon"></i>
              ...
              <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th style="color:#17bce6">Finance</th>
                    <th style="color:#17bce6">Custodium</th>
                    <th style="color:#17bce6">Security</th>
                    <th style="color:#17bce6">Action</th>
         ...
         if ($emails) {
            ...
            while ($response = mysqli_fetch_assoc($result)) {
              ...
              $status = 'status';
               ...
               if($response['finance']==1){
                echo "<td><button class='btn btn-success' disabled>OK</button></td>";
                // echo "<td><a href='?type=$status&operation=deactive&id=$id' class='btn btn-primary' disabled>OK</a></td>";
              }
              else{
                echo "<td><button class='btn btn-success' disabled><a href='?type=status&operation=active&id=$id'>Pending</a></button></td>";
              }
              if($response['custodium']==1){
                echo "<td><button class='btn btn-success' disabled>OK</button></td>";
                // echo "<td><a href='?type=$status&operation=deactive&id=$id' class='btn btn-primary' disabled>OK</a></td>";
              }
              else{
              ...
              if($response['placed']==1){
                echo "<td><button class='btn btn-warning' disabled>Booked</button></td>";

                // echo "<td><a href='?type=$status&operation=deactive&id=$id' class='btn btn-primary' disabled>Conform</a></td>";
              }
              else{
                $from=$response['from'];
                echo "<td><a href='?type=status&operation=active&id=$id&to=$from' class='btn btn-primary'><button id='confirm'>Pending</button></a></td>";
              }
               echo '</tr>';
               echo '</tbody>';
               $a++;
...
$("#confirm").on("click", function(){
   ...
   <?php
    ...
    $headers = "From: salessectionnerljn@gmail.com";
