  ...
  if(isset($_REQUEST['type']) && $_REQUEST['type']!='')
      {
        if($_REQUEST['type']=='status')
        {
          ...
          $update_status_sql="update request set security=$status where id=$id";
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Hello, <span class="text-black fw-bold">Security</span></h1>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="fw-light text-muted mb-0">security@gmail.com</p>
              </div>
              ...
              <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th style="color:#17bce6">Reschedule</th>
                  </tr>
                </thead>
         ...
         if ($emails) {
            ...
            while ($response = mysqli_fetch_assoc($result)) {
              ...
              if($response['security']==1){
                echo "<td><button class='btn btn-success' disabled>Conform</button></td>";

                // echo "<td><a href='?type=$status&operation=deactive&id=$id' class='btn btn-primary' disabled>Conform</a></td>";
              }
              else{
                echo "<td><a href='?type=status&operation=active&id=$id' class='btn btn-info'>Pending</a></td>";
              }
               echo "<td><input type='date'>&nbsp;&nbsp;<button class='btn btn-warning' id=''>Reschedule</button></td>";
               echo '</tr>';
               echo '</tbody>';
               $a++;
            }
